...
import { type FilesystemBrowseInput, type ProjectEntry } from "@ytools/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@ytools/shared/path";
import {
  insertRankedSearchResult,
  normalizeSearchQuery,
  scoreQueryMatch,
  type RankedSearchResult,
} from "@ytools/shared/searchRanking";
