...
import { EDITORS, OpenError, type EditorId } from "@ytools/contracts";
import { isCommandAvailable, type CommandAvailabilityOptions } from "@ytools/shared/shell";
...
export { OpenError };
export { isCommandAvailable } from "@ytools/shared/shell";
