...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@ytools/shared/git`, `@ytools/shared/DrainableWorker`) — no barrel index.
